			 				...
			 				<form class="row g-3 test-validation" action="register" method="post" novalidate>
			 					<div class="col-md-6">
								  ...
								  <div class="col-12">
								    ...
								    <input type="text" name="addresse" class="form-control" id="inputAddress" placeholder="Rue 4 N° 35" required>
								    <div class="invalid-feedback">
								  ...
								  <div class="col-md-5">
								    ...
								    <input type="text" name="telephone" class="form-control" id="inputCity" min=10 required>
								    <div class="invalid-feedback">
								  ...
								  <div class="col-md-4">
								    ...
								    <input type="text" name="filiere" class="form-control" id="inputCity" required>
								    <div class="invalid-feedback">
								  ...
								  <div class="col-md-3">
								    ...
								    <input type="Number" name="age" min=0 max=50 class="form-control" id="inputZip">
								  </div>
								  <div class="col-4 ps-3 m-3">
